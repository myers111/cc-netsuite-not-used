...
function() {
    ...
    function validateField(context) {
    	...
    	if (context.sublistId != 'custpage_subitemslist') return true;
    	if (context.fieldId != 'custpage_quantity') return true;
    	...
    	if (quantity <= 0) alert('Invalid number (must be positive)');
