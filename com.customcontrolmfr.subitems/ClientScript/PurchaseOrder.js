...
function(currentRecord,record,url,search) {
    ...
    function subitemNew() {
        ...
        var recordURL = url.resolveRecord({
            ...
            isEditMode: true,
            params: {
                'record.custrecord_ccm_si_purchaseorder': id
            }
        });
    ...
    function subitemReceive() {
        ...
        var recordURL = url.resolveRecord({
            ...
            isEditMode: true,
            params: {
                'record.custrecord_ccm_sir_purchaseorder': id
            }
        });
    ...
    return {
        ...
        subitemNew:  subitemNew,
        subitemReceive: subitemReceive
    };  
});
